...
async function main(){
    ...
    const logFilePath = path.join(logsDir, `${txHash}.json`);
    fs.writeFileSync(logFilePath, JSON.stringify(receipt.logs, null, 2));
    console.log(`Event logs saved to ${logFilePath}`);
